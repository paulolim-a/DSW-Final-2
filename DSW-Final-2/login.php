                ...
                <div class="formlogin">
                    <form action="validaLogin.php" method="POST">
                        ...
                        <div class="inputBox user">
                            ...
                            <input type="text" name="userName" id="iusuario" maxlength="60" autocomplete="nickname" required placeholder="  Informe seu nome de usuário" title="Informe seu usuário" alt="Informe seu usuário" autofocus>
                        </div>
    
                        <div class="inputBox password">
                            <label for="ipasw">Senha: </label>
                            <input type="password" name="password" id="ipasw" required minlength="4" placeholder="  Informe sua senha" title="Informe sua senha" alt="Informe sua senha">
                        </div>
