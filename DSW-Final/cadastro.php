<?php
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios(name,logintb,passwordtb,email) VALUES ('$name','$logintb','$passwordtb','$email')");
                ...
                <div class="formlogin">
                    <form action="cadastro.php" method="POST">
                        ...
                        <div class="inputBox user">
                            ...
                            <input type="text" name="user" id="iuser" minlength="4" maxlength="60" autocomplete="on" required placeholder="  Informe seu nome de usuário" title="Informe seu usuário" alt="Informe seu usuário">
                        </div>
